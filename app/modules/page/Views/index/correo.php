      ...
      <div class="row w-100 text-center justify-content-center">
        <div class="col-lg-9 col-md-10 col-11">
          <div class="row">
            ...
            <div class="col-12">
              <h3 class="login-title" style="font-size: 2.4rem;">Realiza tu solicitud de cambio de correo</h3>
            </div>
            <div class="col-lg-10 col-md-12 mx-auto">
              <p class="login-par">
                <br>
                <br>
                Llena el formulario y se enviara una solicitud a un encargado para revisar y aprobar tu cambio de correo.
                <br><br>
              </p>
            </div>
            ...
            <div class="col-xxl-6 col-md-7 col-9 mx-auto">
              <form action="/page/index/crearSolicitudCorreo" method="post" class="row" id="correo-recuperacion" autocomplete="off">
                ...
                <div class="col-12 mb-3">
                  <input type="text" class="form-control no-symbols" name="dv" placeholder="DV (si aplica)" autocomplete="off">
                </div>
                <div class="col-12 mb-3">
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-primary w-100" disabled>Enviar Solicitud</button>
                </div>
              </form>
            </div>
          </div>
