...
class Page_indexController extends Page_mainController
{
  ...
  public function registrarAction()
  {
    ...
    if (!$user) {
      ...
      $dataSolicitud['dv'] = '';
      $dataSolicitud['email'] = $datosProveedor['emailProveedor'];
      ...
      $userData['dv'] = '';
      $userData['email'] = $datosProveedor['emailProveedor'];
  ...
  {
    $result = $this->traerTodosProveedores();

    if (!$result) {
      return ['status' => 'error', 'message' => 'Error al consultar proveedores. Intente nuevamente o contacte al administrador.'];
    }
...
<soapenv:Envelope 
    ...
    xmlns:get="https://testopain.itbid.org/soap/getInfoOpainBi">
    <soapenv:Header/>
    <soapenv:Body>
        <get:getInfoOpainBi>
  ...
  {
    $nit = '900725406';
    $proveedor = $this->consultarProveedorPorNit($nit);
    var_dump($proveedor);
    die;
  }
