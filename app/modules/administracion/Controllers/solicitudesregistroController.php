 ...
 */
class Administracion_solicitudesregistroController extends Administracion_mainController
{
  public $botonpanel = 5;
  /**
   ...
   * @var string
   */
  protected $_csrf_section = "administracion_solicitudesregistro";
  ...
  {
    $this->mainModel = new Administracion_Model_DbTable_Solicitudesregistro();
    $this->namefilter = "parametersfiltersolicitudesregistro";
    $this->route = "/administracion/solicitudesregistro";
    $this->namepages = "pages_solicitudesregistro";
    $this->namepageactual = "page_actual_solicitudesregistro";
  ...
  {
    $title = "Aministración de Solicitudes de Registro";
  ...
  public function insertAction()
  {
    ...
    if (Session::getInstance()->get('csrf')[$this->_getSanitizedParam("csrf_section")] == $csrf) {
      ...
      $data['log_tipo'] = 'CREAR SOLICITUDES DE REGISTRO';
  ...
  public function updateAction()
  {
    ...
    if (Session::getInstance()->get('csrf')[$this->_getSanitizedParam("csrf_section")] == $csrf) {
      ...
      $data['id'] = $id;
      $data['log_log'] = print_r($data, true);
      $data['log_tipo'] = 'EDITAR SOLICITUDES DE REGISTRO';
      $logModel = new Administracion_Model_DbTable_Log();
      $logModel->insert($data);
    }
    header('Location: ' . $this->route . '' . '');
  ...
  {
    $id = $this->_getSanitizedParam("id");
    $solicitudesModel = new Administracion_Model_DbTable_Solicitudesregistro();
    $solicitud = $solicitudesModel->getById($id);
    $userData = array();
    $userData['razon_social'] = $solicitud->razon_social;
    $userData['identificacion'] = $solicitud->rut_cc_ce_pasaporte;
    $userData['dv'] = $solicitud->dv;
    $userData['email'] = $solicitud->email;
    $userData['contacto_nombre'] = $solicitud->nombre_contacto;
    $userData['contacto_cargo'] = $solicitud->cargo;
