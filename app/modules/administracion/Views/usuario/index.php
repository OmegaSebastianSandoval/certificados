				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							...
							<td class="text-right">
								<div>
									<?php if ($_SESSION['kt_login_level'] == 1) { ?><a class="btn btn-azul btn-sm" href="<?php echo $this->route; ?>/manage?id=<?= $id ?>" data-bs-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-pen-alt"></i></a><?php } ?>
