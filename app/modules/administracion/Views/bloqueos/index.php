        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="bloqueo_usuario" value="<?php echo $this->getObjectVariable($this->filters, 'bloqueo_usuario') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>fecha intento</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-verde " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="bloqueo_fechaintento" value="<?php echo $this->getObjectVariable($this->filters, 'bloqueo_fechaintento') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="bloqueo_intentosfallidos" value="<?php echo $this->getObjectVariable($this->filters, 'bloqueo_intentosfallidos') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>ip</label>
		            ...
		            <input type="text" class="form-control" name="bloqueo_ip" value="<?php echo $this->getObjectVariable($this->filters, 'bloqueo_ip') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->bloqueo_id; ?>
					<tr>
						<td><?=$content->bloqueo_usuario;?></td>
						<td><?=$content->bloqueo_fechaintento;?></td>
						<td><?=$content->bloqueo_intentosfallidos;?></td>
						<td><?=$content->bloqueo_ip;?></td>
						<td class="text-right">
							<div>
