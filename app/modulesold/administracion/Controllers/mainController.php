...
class Administracion_mainController extends Controllers_Abstract
{
	...
	public function init()
	{
		...
		$omegaToken = md5(Session::getInstance()->get("kt_login_id") . "_OMEGA");
