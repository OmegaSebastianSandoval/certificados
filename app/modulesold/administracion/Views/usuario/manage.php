...
<div class="container-fluid">
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform;?>"  data-bs-toggle="validator">
		<div class="content-dashboard">
			...
			<?php if ($this->content->user_uid) { ?>
				<input type="hidden" name="id" id="id" value="<?= $this->content->user_uid; ?>" />
			<?php }?>
			<div class="row">
				...
				<div class="col-4 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->user_cedula; ?>" name="user_cedula" id="user_cedula" class="form-control"  required >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-4 form-group">
				...
				<div class="col-4 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->user_telefono; ?>" name="user_telefono" id="user_telefono" class="form-control"  required >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-4 form-group">
