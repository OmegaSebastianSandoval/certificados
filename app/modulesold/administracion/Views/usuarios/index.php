...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post">
		<div class="content-dashboard">
			<div class="row">
				...
				<div class="col-3">
					<label>NIT, RUT, CC, CE, Pasaporte</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-verde "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="identificacion" value="<?php echo $this->getObjectVariable($this->filters, 'identificacion') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>DV</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="dv" value="<?php echo $this->getObjectVariable($this->filters, 'dv') ?>"></input>
					</label>
				</div>
				<div class="col-3">
	...
	<div align="center">
		<ul class="pagination d-flex justify-content-start" style="overflow-x: auto;">
			<?php
			$url = $this->route;
