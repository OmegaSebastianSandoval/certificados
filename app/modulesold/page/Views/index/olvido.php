        ...
        <div class="col-lg-9 col-md-10 col-11">
          <div class="row">
            ...
            <div class="col-lg-10 col-md-12 mx-auto">
              ...
              <br>
              <br>
                Ingresa tu NIT, si existe un usuario creado con tu ese NIT te llegara un mensaje al correo vinculado a tu cuenta.
                <br><br>
              </p>
            </div>
            ...
            <div class="col-xxl-6 col-md-7 col-9 mx-auto">
               <form action="/page/index/enviarRecuperacion" method="post" class="row" id="olvido">
                <input type="text" class="form-control mb-3 no-symbols" name="identificacion" placeholder="NIT" required  autocomplete="off">
