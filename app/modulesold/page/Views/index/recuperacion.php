          ...
          <div class="row">
            ...
            <div class="col-12 mb-5 mt-3">
              <div class="d-flex login-terms justify-content-center align-items-center">
                ...
                <span>
                  Aceptar <span class="underline" data-bs-toggle="modal" data-bs-target="#termsModal">términos y condiciones.</span>
                </span>
              </div>
            </div>
            <?php if($this->error){ ?>
            ...
            <?php }else{ ?>
              <div class="col-xxl-6 col-md-7 col-9 mx-auto">
                 <form action="/page/index/recuperarClave" method="post" class="row" id="change" autocomplete="off">
                  <input type="hidden" value="<?php echo $this->user->id ?>" name="user_id">
                  <input type="password" class="form-control mb-3" name="password" placeholder="Contraseña" required autocomplete="new-password" >
                  <input type="password" class="form-control mb-3" name="password2" placeholder="Repite tu contraseña" required autocomplete="new-password" >
